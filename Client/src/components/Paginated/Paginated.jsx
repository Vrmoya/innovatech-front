...
const Paginated = () => {
  ...
  const productsByCategoriesLength = useSelector(
 ...
 /* useEffect que calcula el totalPages */
  useEffect(() => {
  ...
  }, [products, productsByCategoriesLength]);

 /* useEffect que vuelve a la pagina 1 al cambiar de categoria u order */
  useEffect(() => {
    setInput("1");
  }, [categories, order]);
  ...
  return (
    <div className={style.container}>
      ...
      <button
        className={style.button}
        onClick={next}
        disabled={parseInt(input) === disableButtonNext}
      >
